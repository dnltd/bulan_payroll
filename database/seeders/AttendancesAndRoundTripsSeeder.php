...
class AttendancesAndRoundTripsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Fixed payroll week: Sep 6 (Sat) → Sep 112 (Fri), 2025
        $start = Carbon::create(2025, 9, 6); // Saturday
        $end   = Carbon::create(2025, 9, 12); // Friday
